...
; Based on the Pidgin installer by Herman Bloggs and the Pidgin-Encryption
; installer by Bill Tompkins
;
; Uses NSIS v3.0
...
;--------------------------------
;General
Name "Retro PRPL ${RETRO_PRPL_VERSION}"

;Do A CRC Check
CRCCheck On

;Output File Name
OutFile "${BUILD_ROOT}\retro-prpl-${RETRO_PRPL_VERSION}.exe"
...
Section "Install"
  ...
  instrights_hklm:
    ...
    WriteRegStr HKLM ${RETRO_PRPL_REG_KEY} "Version" "${RETRO_PRPL_VERSION}"
